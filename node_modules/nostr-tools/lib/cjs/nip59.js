...
var JS = class {
  ...
  getPublicKey(secretKey) {
    return (0, import_utils6.bytesToHex)(import_secp256k12.schnorr.getPublicKey(secretKey));
  }
  finalizeEvent(t, secretKey) {
    const event = t;
    event.pubkey = (0, import_utils6.bytesToHex)(import_secp256k12.schnorr.getPublicKey(secretKey));
    event.id = getEventHash(event);
    event.sig = (0, import_utils6.bytesToHex)(import_secp256k12.schnorr.sign((0, import_utils6.hexToBytes)(getEventHash(event)), secretKey));
  ...
  verifyEvent(event) {
    ...
    try {
      ...
      const valid = import_secp256k12.schnorr.verify((0, import_utils6.hexToBytes)(event.sig), (0, import_utils6.hexToBytes)(hash), (0, import_utils6.hexToBytes)(event.pubkey));
...
function getEventHash(event) {
  ...
  return (0, import_utils6.bytesToHex)(eventHash);
}
var i = new JS();
